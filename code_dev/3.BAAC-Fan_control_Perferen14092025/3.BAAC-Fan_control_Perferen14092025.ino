...
// กำหนดค่า Network
byte mac[] = { 0x81, 0xF3, 0xDA, 0x4B, 0x22, 0x4C };
...
// MQTT broker
// ****************** MQTT Settings **********************
const char* dataTopic= "BAACTW022/DATA";                // ใช้สำหรับส่งข้อมูล MQTT
const char* controlTopic = "BAACTW022/CONTROL";          // ใช้สำหรับสั่ง ปิด/เปิด
...
void SendDataMQTT() {
  ...
  Serial.print("Sent:BAACTW022/DATA ");
  Serial.println(msgBuffer);
  esp_task_wdt_reset();  // feed watchdog
}
